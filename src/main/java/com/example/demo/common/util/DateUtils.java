...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static Long getMonthFirstDayTime() {
        return LocalDateTime.of(LocalDate.now(), LocalTime.MIN)
                .with(TemporalAdjusters.firstDayOfMonth()).toInstant(ZoneOffset.of("+8")).toEpochMilli();
    }
    ...
    public static Long getMonthLastDayTime() {
        return LocalDateTime.of(LocalDate.now(), LocalTime.MAX)
                .with(TemporalAdjusters.lastDayOfMonth()).toInstant(ZoneOffset.of("+8")).toEpochMilli();
    }
